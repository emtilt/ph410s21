...
-   Course web pages:
	...
	- [Our Slack workspace](http://physicsatregis.slack.com) - Collaboration, solutions, polls, reading quizzes, etc. <!--[(Invitation link to join the workspace)](https://join.slack.com/t/ph410f19/shared_invite/enQtNzMyMDIyODQ0NzI3LTc1ODliZjEzNzkwNjM0OWIyMGVlMjdiOWFmNjlmMDgwMTcxZjE3MTEwMmFiZWVlZDI4OTJkNzk1MDJmYTFkMzY).--> Please enjoy the [giphy](https://get.slack.help/hc/en-us/articles/204714258-Giphy-for-Slack#post-a-gif) integration responsibly.
...
If we are able to have traditional written exams, then for both Exam 1 and 2, you will be allowed to rework the exams to earn up to 30% of the credit that
