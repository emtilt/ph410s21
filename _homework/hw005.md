...
3. Sketch this function $\rho(\mathbf{r})$ in a manner that clearly describes its characteristics. Label how the function is behaving in different region (e.g., at $r=0$, near $r=0$, and in the far-field).
