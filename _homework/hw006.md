...
Homework 5 emphasizes the conductor problem, which requires new methods to approach finding $V$ or $E$ as we are often unable to find $\rho$ a priori. In the presense of an external electric field, charges will shift in a conductor, thus complicating matters of finding $\rho$. 
...
#### (This image is broken. I'm working on replacing it.)
