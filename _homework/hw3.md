...
4. Having done the above, briefly discuss the advantages and disadvantages of using Gauss’ Law to find the electric field instead of using Coulomb’s Law (Griffiths Equation 2.8)?  What role does symmetry play?  
