...
<section data-markdown>
  ...
  $$\nabla\times\mathbf{B}=\mu_0\epsilon_0\frac{\partial E}{\partial t}$$
...
<section data-markdown>
  ...
  $$\nabla\left(\nabla\cdot\mathbf{E}\right)-\nabla^2\mathbf{E}=-\frac{\partial}{\partial t}\left(\mu_0\epsilon_0\frac{\partial E}{\partial t}\right)$$
  
  $$\nabla^2\mathbf{E}=\left(\mu_0\epsilon_0\frac{\partial^2 E}{\partial t^2}\right)$$

  Similarly from Ampere:   $\nabla^2\mathbf{B}=\left(\mu_0\epsilon_0\frac{\partial^2 B}{\partial t^2}\right)$
