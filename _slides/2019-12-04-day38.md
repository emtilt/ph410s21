...
<section data-markdown>
  ...
  $$\nabla^2\mathbf{E}=\left(\mu_0\epsilon_0\frac{\partial^2 \mathbf{E}}{\partial t^2}\right)$$

  Similarly from Ampere:   $\nabla^2\mathbf{B}=\left(\mu_0\epsilon_0\frac{\partial^2 \mathbf{B}}{\partial t^2}\right)$
