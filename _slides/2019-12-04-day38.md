...
<section data-markdown>
  ...
  $$\nabla\times\mathbf{E}=-\frac{\patial \mathbf{B}}{\partial t}$$
  
  $$\nabla\times\mathbf{B}=\mu_0\epsilon_0\frac{\patial E}{\partial t}$$
...
<section data-markdown>
  ...
  $$\nabla\times\left(\nabla\times\mathbf{E}\right)=-\frac{\patial}{\partial t}\left(\nabla\times\mathbf{B}\right)$$
  
  $$\nabla\left(\nabla\cdot\mathbf{E}\right)-\nabla^2\mathbf{E}=-\frac{\patial}{\partial t}\left(\mu_0\epsilon_0\frac{\patial E}{\partial t}\right)$$
  
  $$\nabla^2\mathbf{E}=\left(\mu_0\epsilon_0\frac{\patial^2 E}{\partial t^2}\right)$$

  Similarly from Ampere:   $\nabla^2\mathbf{B}=\left(\mu_0\epsilon_0\frac{\patial^2 B}{\partial t^2}\right)$
